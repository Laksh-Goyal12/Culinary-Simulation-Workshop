...
const FlavorRadar = ({ data }) => {
    ...
    return (
        <div style={{ width: '100%', height: '320px', position: 'relative', flexShrink: 0, marginTop: '8px' }}>
            {/* Background Glow */}
            <div style={{
            ...
            <div style={{ width: '100%', height: '260px', position: 'relative', zIndex: 1 }}>
                <ResponsiveContainer width="100%" height="100%">
                    <RadarChart cx="50%" cy="50%" outerRadius="70%" data={data}>
                        ...
                        />
                        {/* Interactive Tooltip */}
                        {/* <Tooltip content={<CustomTooltip />} cursor={{ stroke: 'var(--color-neon-cyan)', strokeWidth: 1, strokeDasharray: '4 4' }} /> */}
                    </RadarChart>
                </ResponsiveContainer>
            </div>
